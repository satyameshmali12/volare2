...
export default async function TeamVerticalPage({ params }) {
  ...
  // Get members directly from the static data file
  const members = TeamMembers.filter(
    (member) => member.vertical === normalizedVertical,
  ...
  return (
    <main className="min-h-screen bg-[#f5f5f3] text-black">
      {/* HEADER */}
      <section
        className="mx-6 border-b border-black/10"
                      ...
                      <div className="mt-3 flex gap-2">
                        {member.linkedin && (
                          <a
                            ...
                            className="rounded-full border border-black/10 px-2.5 py-1.5 text-[8px] uppercase tracking-[0.15em] text-black/50 transition hover:border-black hover:bg-black hover:text-white sm:px-3"
                          >
                            LinkedIn
                          </a>
                        )}
      ...
      <section className="border-t border-black/10 px-5 py-10 sm:px-8 lg:px-12">
        <div className="mx-auto flex max-w-7xl justify-between">
          <Link
            href="/team"
            className="group flex items-center gap-3 text-[10px] uppercase tracking-[0.25em] text-black/50 transition hover:text-black"
          >
